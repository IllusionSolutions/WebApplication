...
$(function() {
	...
	*/
    ...
    var setUpFirebaseEvents = function() {
        listRef = new Firebase('https://powercloud-bf968.firebaseio.com/lists/sharedlist/items');
        $("#sharedlist").html('');
    ...
    var removeItemFromFirebase = function(key) {
        var itemRef = new Firebase('https://powercloud-bf968.firebaseio.com/lists/sharedlist/items/' + key);
        itemRef.remove();
    }
    ...
    var addUserName = function(userid) {
		...
		if(!name)
			name = userid;
        var userRef = new Firebase('https://powercloud-bf968.firebaseio.com/users/' + userid);
        userRef.set({
            full_name: name
        },
